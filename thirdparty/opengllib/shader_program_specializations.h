...
void shader_program<ogllib::vertex_p>::set_attrib_pointers()
{
	...
	glVertexAttribPointer(index, 3, gl::GLenum::GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat), (GLvoid *)0);
...
void shader_program<ogllib::vertex_pc>::set_attrib_pointers()
{
	...
	glVertexAttribPointer(posIndex, 3, gl::GLenum::GL_FLOAT, GL_FALSE, sizeof(ogllib::vertex_pc), reinterpret_cast<void *>(posOffset));
	glEnableVertexAttribArray(posIndex);

	glVertexAttribPointer(colIndex, 4, gl::GLenum::GL_FLOAT, GL_FALSE, sizeof(ogllib::vertex_pc), reinterpret_cast<void *>(colOffset));
...
void shader_program<ogllib::vertex_ptx2d>::set_attrib_pointers()
{
	...
	glVertexAttribPointer(posIndex, 3, gl::GLenum::GL_FLOAT, GL_FALSE, sizeof(ogllib::vertex_ptx2d), reinterpret_cast<void *>(posOffset));
	glEnableVertexAttribArray(posIndex);

	glVertexAttribPointer(txIndex, 2, gl::GLenum::GL_FLOAT, GL_FALSE, sizeof(ogllib::vertex_ptx2d), reinterpret_cast<void *>(txOffset));
...
void shader_program<ogllib::vertex_pctx2d>::set_attrib_pointers()
{
	...
	glVertexAttribPointer(posIndex, 3, gl::GLenum::GL_FLOAT, GL_FALSE, sizeof(ogllib::vertex_pctx2d), reinterpret_cast<void *>(posOffset));
	glEnableVertexAttribArray(posIndex);

	glVertexAttribPointer(colIndex, 4, gl::GLenum::GL_FLOAT, GL_FALSE, sizeof(ogllib::vertex_pctx2d), reinterpret_cast<void *>(colOffset));
	glEnableVertexAttribArray(colIndex);

	glVertexAttribPointer(txIndex, 2, gl::GLenum::GL_FLOAT, GL_FALSE, sizeof(ogllib::vertex_pctx2d), reinterpret_cast<void *>(txOffset));
	glEnableVertexAttribArray(txIndex);
}
