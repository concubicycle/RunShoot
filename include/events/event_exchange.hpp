...
namespace events
{
    ...
    typedef event<const std::string&> string_event;
    typedef event<> void_event;
    ...
    typedef std::tuple<
        ...
        std::unordered_map<event_type, camera_float_assign_event>,
        std::unordered_map<event_type, string_event>,
        std::unordered_map<event_type, void_event>> event_maps;
